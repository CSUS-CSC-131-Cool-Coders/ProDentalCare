...
export const routes: Routes = [
  ...
  { path: "patient/dashboard", component: PatientOverviewComponent },
  ...
  { path: "process-payment", component: PaymentPageComponent },
  ...
  { path: "patient/payments", component: PaymentComponent },
  { path: "patient/process-payment", component: PaymentPageComponent }
];
